...
def test_chart_type_detection():
    ...
    try:
        from scalapay.scalapay_mcp_kam.chart_config.chart_styling_config import detect_chart_type_from_data_type, ChartType
...
def test_style_selection():
    ...
    try:
        from scalapay.scalapay_mcp_kam.chart_config.chart_styling_config import select_style_config, get_image_style_for_slide
