...
class ConcurrencyConfig:
    ...
    def from_env(cls) -> 'ConcurrencyConfig':
        ...
        return cls(
            enable_concurrent_data_retrieval=_parse_bool_env(
                "SCALAPAY_ENABLE_CONCURRENT_DATA_RETRIEVAL", True
            ),
            ...
            enable_concurrent_chart_generation=_parse_bool_env(
                "SCALAPAY_ENABLE_CONCURRENT_CHART_GENERATION", True
            ),
            ...
            enable_concurrent_slides_processing=_parse_bool_env(
                "SCALAPAY_ENABLE_CONCURRENT_SLIDES_PROCESSING", True
            ),
            ...
            enable_concurrent_batch_operations=_parse_bool_env(
            ...
            enable_fallback_to_sequential=_parse_bool_env(
                "SCALAPAY_ENABLE_FALLBACK_TO_SEQUENTIAL", True
            )
        )
