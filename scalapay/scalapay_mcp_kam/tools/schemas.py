...
class GetPresentationArgs(BaseModel):
    presentation_id: str = Field(..., min_length=1, alias="presentationId", description='"presentationId" (string) is required.')
...
class GetPageArgs(BaseModel):
    presentation_id: str = Field(..., min_length=1, alias="presentationId", description='"presentationId" (string) is required.')
    page_object_id: str = Field(..., min_length=1, alias="pageObjectId", description='"pageObjectId" (string) is required.')
